  ...
  <div class="task-search card hover-lift">
    ...
    <div class="filters-row">
        ...
        <div class="priority-toggles">
            <button class="prio-btn low" :class="{ active: priorityFilter.includes('low') }" @click="togglePriority('low')" title="Baja"></button>
            <button class="prio-btn medium" :class="{ active: priorityFilter.includes('medium') }" @click="togglePriority('medium')" title="Media"></button>
            <button class="prio-btn high" :class="{ active: priorityFilter.includes('high') }" @click="togglePriority('high')" title="Alta"></button>
        </div>
...
.suggestions-list li:hover { background: rgba(120, 120, 128, 0.1); }
...
.prio-btn.low { background: var(--success-color); opacity: 0.3; }
.prio-btn.medium { background: var(--warning-color); opacity: 0.3; }
.prio-btn.high { background: var(--danger-color); opacity: 0.3; }
